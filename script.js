...
function showGallery(category) {
    ...
    const photos = {
        ...
        'aae-planes': [
            ...
            { src: "./photos/AAE/aae-p (60).JPG", desc: 'Dassault Breguet / Dornier Alpha Jet (Patrouille de France)' },
            { src: "./photos/AAE/aae-p (61).JPG", desc: 'Dassault Breguet / Dornier Alpha Jet (Patrouille de France)' },
